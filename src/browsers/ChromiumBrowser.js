...
var ChromiumBrowser = /** @class */ (function () {
    function ChromiumBrowser(logger) {
        this.browser = null;
        this.context = null;
        this.logger = logger.agent("ChromiumBrowser");
    }
    ChromiumBrowser.prototype.launch = function () {
    ...
    ChromiumBrowser.prototype.getPage = function (url) {
